...
```
* The container has position is relative and hides the content that overflows.
...
Most of the steps take are displayed for at least a second, with the exception of 4 steps. 3 are much faster (see below steps 13.1%, 20.1% and 60.1%).

The last step is the slowest, and takes about 40% of the animation duration.
