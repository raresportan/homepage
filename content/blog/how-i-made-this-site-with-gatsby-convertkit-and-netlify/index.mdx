...
There were some other little annoying things with this theme, like not including the [external links plugin](https://github.com/JLongley/gatsby-remark-external-links), and thus all the external links were opening in the same tab.
