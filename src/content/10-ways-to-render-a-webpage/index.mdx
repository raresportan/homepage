...
<img src={staticImage} width={600} aspectRatio={353/261} alt="Static website" />
...
import multipageImage from "./multipage.svg";

<img src={multipageImage} width={600} aspectRatio={353/261} alt="Multi-page website" />
...
import spaImage from "./spa.svg";

<img src={spaImage} width={600} aspectRatio={635/327} alt="Single Page Application" />
...
import ssrImage from "./ssr-hydration.svg";

<img width={600} src={ssrImage} aspectRatio={635/327} alt="Server side rendering with Hydration" />
...
import ssgImage from "./ssg.svg";

<img width={600} src={ssgImage} aspectRatio={636/381} alt="Server side generation with Hydration" />
...
import isrImage from "./isr.svg";

<img width={600} src={isrImage}  aspectRatio={635/440} alt="Incremental static regeneration" />
...
import islandsImage from "./islands.svg";

<img width={600} aspectRatio={635/319} src={islandsImage} alt="Islands" />
...
import streamingImage from "./streaming.svg";

<img width={600} aspectRatio={635/311} src={streamingImage} alt="Streaming SSR" />
...
<img width={600} aspectRatio={353/261} src={staticImage} alt="Static website" />
