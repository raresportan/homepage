...
<Image src={staticImage} width={600} alt="Static website" />
...
<Image src={multipageImage} width={600} alt="Multi-page website" />
...
<Image src={spaImage} width={600} alt="Single Page Application" />
...
<Image width={600} src={ssrImage} alt="Server side rendering with Hydration" />
...
<Image width={600} src={ssgImage} alt="Server side generation with Hydration" />
...
<Image width={600} src={isrImage} alt="Incremental static regeneration" />
...
<Image width={600} src={islandsImage} alt="Islands" />
...
<Image width={600} src={streamingImage} alt="Streaming SSR" />
...
<Image width={600} src={staticImage} alt="Static website" />
