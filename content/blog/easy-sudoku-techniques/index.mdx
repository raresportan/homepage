...
[![Demo](./demo.png "Demo of easy Sudoku generator")](https://solving-sudoku.netlify.app/easy)
...
![Pencil marks on a Sudoku](./pencil-marks.png "Pencil marks on a Sudoku")
...
![Naked single on a Sudoku](./naked-single.png "Naked single on a Sudoku")
...
![Naked/Hidden singles on a Sudoku](./naked-hidden-singles.png "Naked/Hidden singles on a Sudoku")
...
![Naked/Hidden pairs on a Sudoku](./naked-hidden-pairs.png "Naked/Hidden pairs on a Sudoku")
...
![Naked triples on a Sudoku](./naked-triples2.png "Naked triples on a Sudoku")
...
![Hidden triples on a Sudoku](./hidden-triples.png "Hidden triples on a Sudoku")
...
![Poiting pairs on a Sudoku](./pointing-pairs.png "Poiting pairs on a Sudoku")
...
![Box/line reduction on a Sudoku](./box-line-reduction.png "Box/line reduction on a Sudoku")
