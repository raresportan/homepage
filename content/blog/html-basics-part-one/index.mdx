...
<html lang="en">
  ...
  <body>
    <main>  // highlight-line
		  CONTENT GOES HERE // highlight-line
    </main> // highlight-line
  </body>
</html>
```
...
<html lang="en">
  ...
  <body>
    <a href="#content">Skip to content</a> // highlight-line
    <main tabindex="-1" id="content">  // highlight-line
		  CONTENT GOES HERE 
    </main> 
  </body>
</html>
...
<html lang="en">
  ...
  <body>
    <a href="#content">Skip to content</a> 
    <header role="banner"> // highlight-line
        <a href="/" aria-label="Home"> // highlight-line
          <svg aria-hidden="true" focusable="false">...</svg> // highlight-line
        </a> // highlight-line
        <nav aria-label="primary"> // highlight-line
          <ul> // highlight-line
            <li><a href="/">Home</a></li> // highlight-line
            <li><a href="/about">About</a></li> // highlight-line
            OTHER LINKS // highlight-line
          </ul> // highlight-line
        </nav> // highlight-line
  ...
  <body>
    ...
    <footer> // highlight-line
      <nav> // highlight-line
        <ul> // highlight-line
          <li> // highlight-line
            <a href="https://twitter.com/my_twitter_name"  // highlight-line
            target="_blank" rel="noreferrer">Twitter</a> // highlight-line
          </li> // highlight-line
          <li> // highlight-line
            <a href="https://github.com/my_github_name"  // highlight-line
            target="_blank" rel="noreferrer">Github</a> // highlight-line
          </li> // highlight-line
        </ul> // highlight-line
      </nav> // highlight-line
      <span>&copy; 2021 All rights reserved.</span> // highlight-line
    </footer> // highlight-line
  </body>
</html>
```
  ...
  <body>
    ...
    <main tabindex="-1" id="content"> 
      <article> // highlight-line
        <h1>PAGE TITLE</h1> // highlight-line
        ... // highlight-line
        REST OF CONTENT // highlight-line
        ... // highlight-line
      </article> // highlight-line
    </main> 
    <footer> 
...
<html lang="en">
  ...
  <body>
    ...
    <aside> // highlight-line 
      <h2>You might also like<h2> // highlight-line
      <ul> // highlight-line
        <li> // highlight-line
          <a href="/intersting-article">Interesting article</a> // highlight-line
        </li> // highlight-line
        <li> // highlight-line
          <a href="/must-read-article">Must read article</a> // highlight-line
        </li> // highlight-line
      </ul>    
    </aside>
    <footer> 
