...
const BlogPostTemplate = ({ data, pageContext, location }) => {
  ...
  const { previous, next, twitterShare } = pageContext
      ...
      <article className='post centered-content'>
        ...
        {twitterShare &&
          <div className='twitter-share'>
            <svg width="48px" viewBox="0 0 256 209" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
              <g>
            ...
            <a href={twitterShare} target="_blank" rel="noreferrer">
              If you found this article useful, please share it with your friends on Twitter
